...
class YoutubeProvider extends OAuth2Impl
{
...
//    protected  $protectedResourceUrl =  "https://www.googleapis.com/youtube/v3/channels?part=contentDetails";
    protected  $protectedResourceUrl =  "https://www.googleapis.com/youtube/v3/channels?part=contentDetails&mine=true";
    ...
    public function getAuthorizationUrl()
    {
        ...
        $_SESSION["YoutubeProvider"] = OAuthUtil::setUpInstance($this);
