    ...
    <div id="main-content"> <!-- Main Content Section with everything -->
        ...
        <div class="content-box"><!-- Start Content Box -->
            ...
            <div class="content-box-header">
                ...
                <?php
                if(isset($hotel_name_from_pageHeader)){
                    ?>
                    <h3><?php echo $hotel_name_from_pageHeader." : "; ?>Wi-Fi Usage Monitoring</h3>

                    <?php
                }
                else{

                    echo "<h3>Wi-Fi Usage Monitoring</h3>";
                }
                ?>
                <div class="clear"></div>
                ...
                <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    ...
                    <form method="post" action="#" name="hotel_selection">
                        <p>
                            ...
                            <select name="hotel_id"  class="small-input" id="hotel_id" onchange="displayAllWifiUsageForGivenHotel(this.value);" >
