			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						<form action="view-results.php" method="post" onsubmit="return emptyvalidate()">
                        <fieldset>
                      
                        <!--For Admins and Billign and NMC and Card activation team Department To view all the custermers-->       
                      <?php if($_SESSION['group_id']==4 || $_SESSION['group_id']==1 || $_SESSION['group_id']==5){ ?>
                      
                       <p>
									<label>Select a Customer</label>              
					<select name="custermer"  class="small-input" id="custermer">
					...
					<select name="custermer"  class="small-input" id="custermer">
                                    	<option value="">Please select</option>
	<?php 
	$CustermersofMarketiers = USER ::getCustermersofMarketiers();
	while($rowcustermersofmarketiers = mysql_fetch_array($CustermersofMarketiers)){
	?>                                        
 <option value="<?php echo $rowcustermersofmarketiers['ID']; ?>"><?php echo $rowcustermersofmarketiers['Name']; ?></option>
  <?php } ?>
          ...
          <?php } ?>  
                        ...
                        <!--For Hotels (Custermers)-->       
                      <?php if($_SESSION['group_id']==3){ ?>
                      
                       <p>
									<label><?php //echo $_SESSION['name'].",  " ?>Please select the date duaration that you want to view the report,</label></label>              
                                    
                  <input type="hidden" id="custermer" name="custermer" value="<?php echo $_SESSION['custermer_id'] ?>"/>                  
