...
if(privileges :: isUserHavingPrivilege($_SESSION['user_id'],7)==false){
        ...
        <div class="content-box"><!-- Start Content Box -->
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    <form action="view-hotel-wifi-usage.php" method="post" onsubmit="return validateWiFiHotelUsageReportRequest();">
                        <fieldset>


                            <!--For JKH Super Admin and LCS Administrators-->
                            <?php if($_SESSION['group_id']==3 || $_SESSION['group_id']==4){ ?>
                            <p>
                                <label>Select a Hotel</label>
                                <select name="hotel"  class="small-input" id="hotel" onchange="set_hotel_selection(this.value);" >
