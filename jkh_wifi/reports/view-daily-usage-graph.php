...
if(privileges :: isUserHavingPrivilege($_SESSION['user_id'],2)==false){
                ...
                <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    ...
                    <form method="post" action="#" name="hotel_selection">
                        <p>
                            ...
                            <select name="hotel_id"  class="small-input" id="hotel_id" onchange="displayDailyGraphForGivenHotel(this.value);" >
