...
if(privileges :: isUserHavingPrivilege($_SESSION['user_id'],5)==false){
                ...
                <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                    ...
                    <form method="post" action="#" name="hotel_selection">
                        <p>
                            ...
                            <select name="hotel_id"  class="small-input" id="hotel_id" onchange="displayWiFiUsageGraphForGivenHotel(this.value);" >
                    ...
                    <div style="color: #3366FF;background:#3366FF; width: 10px;"> .</div> <label style="color: #3366FF;">Download</label>

                    <div style="color: #57a000;background:#57a000; width: 10px;">.</div> <label style="color: #57a000;">Upload</label>
