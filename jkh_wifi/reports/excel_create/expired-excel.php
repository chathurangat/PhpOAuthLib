...
$activeusers = REPORTS::getexpiredusers($custermer_id,$from,$to);
...
//echo 1;
	...
	//$objPHPExcel->getActiveSheet()->SetCellValue('A1','No Results');		
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('A1',"Expired users of ".USER::getcustermerbyid($_REQUEST['custermer']). " From ".$from." To ".$to."");						
...
$objPHPExcel->getActiveSheet()->SetCellValue('E3',"Start Time");
$objPHPExcel->getActiveSheet()->SetCellValue('F3',"Expiry Date");
$objPHPExcel->getActiveSheet()->SetCellValue('G3',"Usage Time");
...
$objPHPExcel->getActiveSheet()->SetCellValue('E'.$x,$wifiuser['starttime']);
$objPHPExcel->getActiveSheet()->SetCellValue('F'.$x,$wifiuser['expiretime']);
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$x,$wifiuser['usagetime']);
$x++;
}

						}
$name = "Expired users of ".USER::getcustermerbyid($_REQUEST['custermer']).time().".xlsx";

// Rename sheet
//echo date('H:i:s') . " Rename sheet\n<br/>";
$objPHPExcel->getActiveSheet()->setTitle('Expired Users');
