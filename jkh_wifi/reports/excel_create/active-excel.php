...
//echo 1;
	...
	//$objPHPExcel->getActiveSheet()->SetCellValue('A1','No Results');		
		...
		$objPHPExcel->getActiveSheet()->SetCellValue('A1',"Active users of ".USER::getcustermerbyid($_REQUEST['custermer']). " From ".$from." To ".$to."");						
...
$name = "Active users of ".USER::getcustermerbyid($_REQUEST['custermer']).time().".xlsx";

// Rename sheet
//echo date('H:i:s') . " Rename sheet\n<br/>";
$objPHPExcel->getActiveSheet()->setTitle('Active Users');
