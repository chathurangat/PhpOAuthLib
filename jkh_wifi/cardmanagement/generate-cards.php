			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						...
						<li><a href="#tab2" class="default-tab">Generate Cards</a></li>
					</ul>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									...
									<select name="custermer" id="custermer" class="small-input">
                                        ...
                                        <option value="0">Blank Card</option>
								...
								<p>
									<label>No Of Cards</label>              
									 <input  class="text-input small-input" type="text" id="no_f_cards"/>
                                    <span id="msg_upldfile"></span>
								</p>
                                
                               	
								<p>
									<label>Select a Package (Card)</label>              
									<select name="package" id="package" class="small-input">
										...
										?>                                        
                                        <option value="<?php echo $rowcardpackages['package_name']; ?>"><?php echo $rowcardpackages['package_name']."  ( Rs. ".$rowcardpackages['price'].")"; ?></option>
                                        <?php } ?>
                                ...
                                <p><span id="msg_generate_cards"></span></p>
                                
								<p>
									<input class="button" type="button" value="Generate" onclick="generatecards();"/>
								</p>
