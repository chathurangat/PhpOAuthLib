    ...
    <div id="main-content"> <!-- Main Content Section with everything -->
        ...
        <div class="content-box"><!-- Start Content Box -->
            ...
            <div class="content-box-content">
                ...
                <input type="submit" name="submit"class="button" value="Get Sessions" />
                </form>
                    ...
                    if (!empty($roomUsage)) {
                        foreach ($roomUsage as $usageData) {
                            ...
                            <tr>
                                ...
                                <td ><?php echo round($usageData['download_bytes']/(1024*1024),4);?></td>
                                <td ><?php echo round($usageData['upload_bytes']/(1024*1024),4);?></td>
