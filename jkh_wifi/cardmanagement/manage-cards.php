						...
						<form action="#" method="post" name="managecards">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									...
									<select name="enable_disable" id="enable_disable" class="small-input" onchange="filtercards()">
                                    	<option value="">Please select</option>									                                     <option value="1">Enable</option>
								...
								<p>
									...
									<select name="custermer" id="custermer" class="small-input" onchange="filtercards()">
                                ...
                                <p>
									...
									<select name="package" id="package" class="small-input" onchange="filtercards()">
                                    	<option value="">Please select</option>
										<?php 
                              ...
                              <p>
									...
									<select name="nas" id="nas" class="small-input" onchange="twin1(this.value)" >
                                    	<option value="">Please select</option>
										<?php 
                                    ...
                                    <span  id="service_ld">           
									<select name="service" id="service" class="small-input" onchange="filtercards()">
                                ...
                                <p><span id="filtered_data"></span></p>
