        ...
        <div class="content-box"><!-- Start Content Box -->
            ...
            <div class="content-box-content">
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="user_id" id="user_id" value="<?php echo base64_decode($_GET["id"]); ?>"/>

                    <input type="button" class="button" value="Change" onclick="change_admin_user_passwords()"/>
